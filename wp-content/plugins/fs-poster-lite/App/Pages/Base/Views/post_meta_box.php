	...
	<div class="fsp-card-body">
		...
		<div id="fspMetaboxShareContainer">
			<div class="fsp-metabox-tabs">
				...
				<div data-tab="twitter" class="fsp-metabox-tab fsp-tooltip fsp-temp-tooltip" data-title="<?php echo esc_html__( 'Show only Twitter accounts', 'fs-poster' ); ?>">
			...
			<div class="fsp-metabox-accounts">
				...
				<?php foreach ( $fsp_params[ 'active_nodes' ] as $node_info )
				{
					...
					$sn_names = [
						...
						'twitter'   => esc_html__( 'Twitter', 'fs-poster' ),
			...
			<div id="fspMetaboxCustomMessages" class="fsp-metabox-custom-messages">
				...
				<div data-driver="twitter">
					...
					<textarea class="fsp-form-textarea" rows="4" maxlength="3000" name="fs_post_text_message_twitter">{title} {link}</textarea>
				</div>
