	...
	class YITH_INFS_Frontend_Premium extends YITH_INFS_Frontend {
		...
		public function enqueue_scripts(){
			...
			if( ! empty( $options ) && is_array( $options ) ) {
				...
				wp_enqueue_script( 'yith-infinitescroll', YITH_INFS_ASSETS_URL . '/js/yith.infinitescroll.js', array('jquery'), $this->version, true );
                wp_localize_script( 'yith-infinitescroll', 'inf', array(
                    'more' => __( 'More', 'gm' ),
                ) );
				wp_enqueue_script( 'yith-infs', YITH_INFS_ASSETS_URL . '/js/yith-infs.js', array('jquery'), $this->version, true );
