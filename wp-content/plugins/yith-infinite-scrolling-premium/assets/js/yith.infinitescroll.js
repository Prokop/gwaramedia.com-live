(function ($, window, document) {
    ...
    $.yit_infinitescroll = function (options) {
        ...
        if( opts.eventType == 'scroll' ) {
            ...
            button = '<div class="yith-infs-button-wrapper"><button type="button" id="yith-infs-button" class="button button-load-more ' + opts.buttonClass + '"><div class="load-btn-inner"><div class="button-content">' +
                '<picture><source srcset="/wp-content/themes/gwara-media/img/svg/load-more-chevron-mob.svg" media="(max-width: 768px)"><img src="/wp-content/themes/gwara-media/img/svg/load-more-chevron.svg" alt="&lt;"></picture><div class="text-inner"><span>' + inf.more + '</span></div><picture><source srcset="/wp-content/themes/gwara-media/img/svg/load-more-chevron-mob.svg" media="(max-width: 768px)"><img src="/wp-content/themes/gwara-media/img/svg/load-more-chevron.svg" alt="&gt;"></picture><div class="loader-content"><div class="circle"></div><div class="circle"></div><div class="circle"></div><img src="/wp-content/themes/gwara-media/img/svg/loader.svg"></div></div></div></button></div>';
